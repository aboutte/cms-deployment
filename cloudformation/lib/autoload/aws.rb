...
def amazon_linux_ami_id
  amazon_linux_amis = AWS_CLIENTS[:ec2].describe_images({
                                                            owners: ['amazon'],
                                                            filters: [
                                                                {
                                                                    name: 'architecture',
...
def get_cidr(subnet)
  ...
  #TODO: can I simplify the networking with the following?
  # require "ipaddr"
  #
  # vpc_start = IPAddr.new '10.0.0.0/16'
  # subnet_start = IPAddr.new '10.0.0.0/24'
